...
def write_db(param):
    try:
        sql = "insert into house (url,listed_price,transaction_cycle,modify_price,square_metre,unit_price,total_price,age_completion,community_name,completion_date) "
